...
export const gettingYourLicenseChapter: StudyGuideChapter = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        "If you are a new resident of Ontario and have a valid driver's licence from another province or country, you can generally use that licence for 60 days after moving to Ontario. To continue driving after that period, you must obtain an Ontario licence.\n\nLicence exchanges:\nOntario has exchange agreements with Canadian provinces and territories and certain other jurisdictions. The licence you receive and any credited experience depend on the licence class, issuing jurisdiction, and verified driving history. Check Ontario's current exchange rules before applying because eligible jurisdictions and document requirements can change.\n\nApplicants from non-reciprocating jurisdictions:\nAs of July 1, 2026, an applicant from a jurisdiction without an exchange agreement may claim a maximum of 12 months of foreign driving experience. The applicant must present an original, valid foreign driver's licence. An authenticated letter from the embassy, consulate, or licensing agency may be required to verify the claimed experience; it must meet Ontario's current language and recency requirements.\n\nApplicants must also meet Ontario's identity and residency requirements, pass the required vision and knowledge tests, pay applicable fees, and complete any required waiting period and road tests. A ministry-approved beginner driver education course may reduce the ordinary G1 waiting period from 12 months to eight months.\n\nBecause the rules depend on individual circumstances, verify your eligibility using the current Ontario and DriveTest instructions before applying.",
      keyPoints: [
        ...
        "Exchange eligibility depends on the issuing jurisdiction and licence class",
        "Identity, residency, vision and knowledge requirements still apply",
        "Non-reciprocating applicants may claim no more than 12 months of foreign experience",
        "An original foreign licence and an authentication letter may be required",
        "Check current Ontario and DriveTest instructions before applying",
